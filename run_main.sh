...
joint_optimizer_lrs={"features":1e-3,"add_on_layers":1e-3,"prototype_vectors":1e-3}
joint_lr_step_size=50

#3e-3 #3e-3
warm_optimizer_lrs={"add_on_layers":3e-3,"prototype_vectors":3e-3} #3e-3

last_layer_optimizer_lr=5e-4 # originally 1e-4 changed by Icxel
...
for fold in $(seq 1)
do
python shape_continuum/ProtoPNet/main.py \
