...
def update_prototypes_on_batch(search_batch_input,
    ...
    for j in range(n_prototypes):
        ...
        global_min_proto_dist_dict['t1'] = global_min_proto_dist
        global_min_proto_dist_dict['fdg'] = global_min_proto_dist
        ...
        if batch_min_proto_dist_j['t1'] < global_min_proto_dist_dict['t1'][j]:
            ...
            global_min_fmap_patches_dict['t1'] = global_min_fmap_patches
            ...
            proto_rf_boxes_dict['t1'] = proto_rf_boxes
            ...
            proto_bound_boxes_dict['t1'] =proto_bound_boxes
            ...
            if dir_for_saving_prototypes is not None:
                ...
                if prototype_img_filename_prefix is not None:
                    ...
                    if rf_img_j['t1'].shape[0] != original_img_size['t1'] or rf_img_j['t1'].shape[1] != original_img_size['t1']:
                        plt.imsave(os.path.join(dir_for_saving_prototypes,
                                                prototype_img_filename_prefix + '-receptive_field_t1' + str(j) + '.png'),
                                   rf_img_j['t1'],
                                   vmin=0.0,
                                   vmax=1.0)
                        overlayed_rf_img_j['t1'] = overlayed_original_img_j['t1'][rf_prototype_j['t1'][1]:rf_prototype_j['t1'][2],
                                                                      rf_prototype_j['t1'][3]:rf_prototype_j['t1'][4]]
                        plt.imsave(os.path.join(dir_for_saving_prototypes,
                                                prototype_img_filename_prefix + '-receptive_field_with_self_act_t1' + str(j) + '.png'),
        ...
        if batch_min_proto_dist_j['fdg'] < global_min_proto_dist_dict['fdg'][j]:
            ...
            # retrieve the corresponding feature map patch
            global_min_fmap_patches_dict['fdg'] = global_min_fmap_patches
            ...
            # save the prototype receptive field information
            proto_rf_boxes_dict['fdg'] = proto_rf_boxes
            ...
            # save the prototype boundary (rectangular boundary of highly activated region)
            proto_bound_boxes_dict['fdg'] =proto_bound_boxes
            ...
            if dir_for_saving_prototypes is not None:
                ...
                if prototype_img_filename_prefix is not None:
                    ...
                    # if different from the original (whole) image, save the prototype receptive field as png
                    if rf_img_j['fdg'].shape[0] != original_img_size['fdg'] or rf_img_j['fdg'].shape[1] != original_img_size['fdg']:
                        plt.imsave(os.path.join(dir_for_saving_prototypes,
                                                prototype_img_filename_prefix + '-receptive_field_fdg' + str(j) + '.png'),
                                   rf_img_j['fdg'],
                                   vmin=0.0,
                                   vmax=1.0)
                        overlayed_rf_img_j['fdg'] = overlayed_original_img_j['fdg'][rf_prototype_j['fdg'][1]:rf_prototype_j['fdg'][2],
                                                                      rf_prototype_j['fdg'][3]:rf_prototype_j['fdg'][4]]
                        plt.imsave(os.path.join(dir_for_saving_prototypes,
                                                prototype_img_filename_prefix + '-receptive_field_with_self_act_fdg' + str(j) + '.png'),
